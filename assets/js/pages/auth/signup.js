...
(function() {
    ...
    function updateSubmitButton() {
        ...
        if (signupButton) {
            signupButton.disabled = !(allValid && termsValid);
            
            if (allValid && termsValid) {
    ...
    function updateGoogleTermsButton() {
        const serviceChecked = document.getElementById('google-terms-service').checked;
        const privacyChecked = document.getElementById('google-terms-privacy').checked;
